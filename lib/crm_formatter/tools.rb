...
module CrmFormatter
  class Tools
    def initialize(args={})
      ...
      @global_hash = { row_id: nil, act_name: nil, street: nil, city: nil, state: nil, zip: nil, phone: nil, url: nil, url_crmf: nil, url_path: nil, web_status: nil, web_neg: nil, web_pos: nil, utf_status: nil }
    end
